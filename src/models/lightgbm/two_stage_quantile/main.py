"""Run only the two-stage quantile (P10/P50/P90) LightGBM model."""
...
def run(
    *, design_path: Path = DEFAULT_DESIGN_PATH, data_dir: Path | None = None,
...
def main() -> None:
    ...
    print(f"Wrote {len(paths)} two-stage quantile result files to {args.results_dir}")
